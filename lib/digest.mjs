 ...
 */
export async function markDelivered(home, today = new Date().toISOString().slice(0, 10)) {
  if (!DATE_ONLY.test(String(today))) {
...
export async function readDigestFile(home, today = new Date().toISOString().slice(0, 10)) {
